...
if __name__ == '__main__':
    ...
    'TREND_EMA_13', 'CHANGE_TREND_EMA_65', 'CHANGE_TREND_EMA_13', 'DIFF_2_EMA_13') and trade_date ='{0}' and ts_code in ({1})) a left join t_tscode_company b on a.ts_code =b.ts_code order 
    by value'''.format(last_cal_day, ts_code_set)
    ...
    feature_info_amount_rank.rename(columns={'company': '公司名', 'trade_date': '交易日期', 'SLOPE_EMA_13': 'EMA13斜率',
                                             ...
                                             'TREND_EMA_13': 'EMA13_MK检验趋势', 'TREND_EMA_65': 'EMA65_MK检验趋势', 'DIFF_2_EMA_13': 'EMA13二阶差分'}, inplace=True)
