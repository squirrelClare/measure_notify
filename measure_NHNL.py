...
#     feature_info = pd.read_sql_query("SELECT t.ts_code, t.trade_date, t.field, t.value FROM public.t_feature_numberic t where t.field='NHNL' and t.trade_date > '{0}' order by t.trade_date desc".format(start_time), engine_finance_db)
