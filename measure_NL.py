...
if __name__ == '__main__':
    ...
    feature_info = pd.read_sql_query("SELECT t.ts_code, t.trade_date, t.field, t.value FROM public.t_feature_numberic t where t.field='NL' and t.trade_date > '2022-01-01' order by t.trade_date desc", engine_finance_db)
